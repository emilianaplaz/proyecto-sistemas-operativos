    ...
    public void enviarComputadoras(){
        try {
            ...
            if(this.getCompania().getTipoCompania() == 0){
                ganancias = (this.getCompania().getAlmacen().getComputadorasEstandar()*250000) + (this.getCompania().getAlmacen().getComputadorasGraficas() * 600000);
                ...
                ganancias = (this.getCompania().getAlmacen().getComputadorasEstandar()*300000) + (this.getCompania().getAlmacen().getComputadorasGraficas() * 650000);
                this.getCompania().getAlmacen().setGanancias(this.getCompania().getAlmacen().getGanancias()+ ganancias, this.getCompania().getTipoCompania());
                this.getCompania().getAlmacen().setUtilidades(this.getCompania().getAlmacen().getUtilidades() + ganancias, this.getCompania().getTipoCompania());
            }
            
            //reiniciamos las computadoras acumulados
            this.getCompania().getAlmacen().setComputadorasEstandar(0, this.getCompania().getTipoCompania());
            this.getCompania().getAlmacen().setComputadorasGraficas(0, this.getCompania().getTipoCompania());
